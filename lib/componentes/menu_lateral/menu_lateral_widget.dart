              ...
              if (FFAppState().perfil == 'Farmácia')
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed(MedicamentosWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      height: 48.0,
              ...
              if (FFAppState().perfil == 'Farmácia')
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed(DoacoesWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      height: 48.0,
              ...
              if (FFAppState().perfil == 'Médico')
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed(ReceitasWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      height: 48.0,
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () async {
                  ...
                  context.goNamedAuth(EntrarWidget.routeName, context.mounted);
                },
                child: Container(
                  width: double.infinity,
                  height: 48.0,
