                ...
                Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              _model.cepmedico = await ConsultaCEPCall.call(
                                cep: _model.tFCnpjTextController.text,
                              );

                              if ((_model.cepmedico?.succeeded ?? true)) {
                    ...
                    if ((_model.validaCEP == true) &&
                        ((_model.cepmedico?.succeeded ?? true) == true))
                      Align(
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Padding(
                          padding: EdgeInsets.all(8.0),
