...
class EntregadorTable extends SupabaseTable<EntregadorRow> {
  @override
  String get tableName => 'entregador';

  @override
  EntregadorRow createRow(Map<String, dynamic> data) => EntregadorRow(data);
}

class EntregadorRow extends SupabaseDataRow {
  EntregadorRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => EntregadorTable();
